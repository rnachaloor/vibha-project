...
const SundayTimeScreen = ({navigation}) => {
  ...
  const submitTimes = async () => {
    ...
    const mtimes = await getData('mondaytimes');
    const tutimes = await getData('tuesdaytimes');
    const wtimes = await getData('wednesdaytimes');
    const thtimes = await getData('thursdaytimes');
    const ftimes = await getData('fridaytimes');
    const satimes = await getData('saturdaytimes');
    const sutimes = await getData('sundaytimes');
    ...
    firestore()
      ...
      .set({
        ...
        mondaytimes: mtimes,
        tuesdaytime: tutimes,
        wednesdaytimes: wtimes,
        thursdaytimes: thtimes,
        fridaytimes: ftimes,
        saturdaytimes: satimes,
        sundaytimes: sutimes,
      })
      .then(() => {
        console.log('SUCCESS');
